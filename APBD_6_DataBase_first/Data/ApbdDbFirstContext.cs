...
namespace APBD_6_DataBase_first.Data;

public partial class ApbdDbFirstContext : DbContext
{
    public ApbdDbFirstContext()
    {
    }

    public ApbdDbFirstContext(DbContextOptions<ApbdDbFirstContext> options)
        : base(options)
    {
    }
